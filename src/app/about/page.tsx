...
const content = {
  en: {
    ...
    sections: [
      ...
      ["Cooperative Brands", "ZOOMLION, ZTM, YONGMAO, DAHAN, SANY, SYM and XCMG."],
    ],
  ...
  zh: {
    ...
    sections: [
      ...
      ["合作品牌", "中联重科 ZOOMLION、中天智装 ZTM、永茂建机 YONGMAO、大汉科技 DAHAN、三一重工 SANY、沈阳三洋 SYM、徐工 XCMG。"],
    ],
  ...
  vi: {
    ...
    sections: [
      ...
      ["Thương Hiệu", "ZOOMLION, ZTM, YONGMAO, DAHAN, SANY, SYM và XCMG."],
    ],
  ...
  ar: {
    ...
    sections: [
      ...
      ["العلامات", "ZOOMLION و ZTM و YONGMAO و DAHAN و SANY و SYM و XCMG."],
    ],

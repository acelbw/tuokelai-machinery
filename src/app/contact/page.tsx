      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <ScrollReveal delay={0.2}>
            <a
              href="mailto:89482764@qq.com"
              className="glass-panel rounded-3xl p-5 border border-brand-border-light flex items-center gap-4 transition-colors hover:border-brand-orange/40"
            >
              <div className="w-10 h-10 rounded-xl bg-brand-orange/5 flex items-center justify-center shrink-0">
                <Mail className="w-5 h-5 text-brand-orange" />
              </div>
              <div>
                <p className="text-xs text-brand-muted">{t(lang, "contact.info.email")}</p>
                <p className="text-sm font-medium text-brand-text">89482764@qq.com</p>
              </div>
            </a>
          </ScrollReveal>
